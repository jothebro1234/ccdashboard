const CONFIG = {
    ...
    // ── Portal: Auth Worker ───────────────────────────────────────
    // Cloudflare Worker that validates director/admin access codes server-side.
    // Codes are stored as Worker environment secrets, NOT here.
    AUTH_WORKER_URL: 'https://cc-auth.curiocrate.org',
